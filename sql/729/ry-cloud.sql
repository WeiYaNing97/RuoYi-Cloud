...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储商品类别的信息' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `example_order_items` VALUES (2, 1, 1, 2, 9600.00, 19200.00, '联想拯救者Y7000P', NULL, 'normal');
...
-- ----------------------------
INSERT INTO `example_orders` VALUES (1, 1, '2025-07-29 23:17:04', 19200.00, 'pending', '河北省衡水市桃城区', NULL, NULL, NULL, NULL, '2025-07-29 23:17:04', '2025-07-29 23:17:04');
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储商品的信息' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `example_users` VALUES (1, '何超莲', 'HeChaoLian521WeiYaNing@163.com', 'Wei971106', NULL, NULL, 'admin', 1, NULL, '2025-07-29 23:09:30', '2025-07-29 23:09:30');
...
) ENGINE = InnoDB AUTO_INCREMENT = 191 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-07-29 22:09:49', '2025-07-15 22:53:55', 'admin', '2025-07-15 22:53:55', '', '2025-07-29 22:09:49', '管理员');
