...
-- ----------------------------
INSERT INTO `gen_table` VALUES (2, 'minio_record', 'minio操作记录', NULL, NULL, 'MinioRecord', 'crud', 'element-ui', 'com.ruoyi.minio', 'minio', 'minio_record', 'minio操作记录', 'ruoyi', '0', '/', '{\"parentMenuId\":2000}', 'admin', '2025-07-20 19:13:16', '', '2025-07-20 22:31:16', NULL);
...
-- ----------------------------
INSERT INTO `gen_table_column` VALUES (10, 2, 'id', '主键', 'bigint(20)', 'Long', 'id', '1', '1', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-07-20 19:13:16', '', '2025-07-20 22:31:16');
INSERT INTO `gen_table_column` VALUES (11, 2, 'file_name', '文件名', 'varchar(50)', 'String', 'fileName', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 2, 'admin', '2025-07-20 19:13:16', '', '2025-07-20 22:31:16');
INSERT INTO `gen_table_column` VALUES (12, 2, 'file_path', '文件路径', 'varchar(255)', 'String', 'filePath', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2025-07-20 19:13:16', '', '2025-07-20 22:31:16');
INSERT INTO `gen_table_column` VALUES (13, 2, 'del_flag', '删除标志（0代表存在 2代表删除）', 'char(1)', 'String', 'delFlag', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 4, 'admin', '2025-07-20 19:13:16', '', '2025-07-20 22:31:16');
INSERT INTO `gen_table_column` VALUES (14, 2, 'create_by', '创建者', 'varchar(64)', 'String', 'createBy', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 5, 'admin', '2025-07-20 19:13:16', '', '2025-07-20 22:31:16');
INSERT INTO `gen_table_column` VALUES (15, 2, 'create_time', '创建时间', 'datetime', 'Date', 'createTime', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'datetime', '', 6, 'admin', '2025-07-20 19:13:16', '', '2025-07-20 22:31:16');
INSERT INTO `gen_table_column` VALUES (16, 2, 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy', '0', '0', NULL, '1', '1', NULL, NULL, 'EQ', 'input', '', 7, 'admin', '2025-07-20 19:13:16', '', '2025-07-20 22:31:16');
INSERT INTO `gen_table_column` VALUES (17, 2, 'update_time', '更新时间', 'datetime', 'Date', 'updateTime', '0', '0', NULL, '1', '1', NULL, NULL, 'EQ', 'datetime', '', 8, 'admin', '2025-07-20 19:13:16', '', '2025-07-20 22:31:16');
INSERT INTO `gen_table_column` VALUES (18, 2, 'remark', '备注', 'varchar(500)', 'String', 'remark', '0', '0', NULL, '1', '1', '1', NULL, 'EQ', 'textarea', '', 9, 'admin', '2025-07-20 19:13:16', '', '2025-07-20 22:31:16');
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'minio操作记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 113 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2023 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '菜单权限表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_menu` VALUES (2010, '上传下载', 2000, 1, 'upload_download', 'minio/upload_download/index', NULL, '', 1, 0, 'C', '0', '0', '', 'upload', 'admin', '2025-07-20 22:05:48', 'admin', '2025-07-20 22:28:47', '');
INSERT INTO `sys_menu` VALUES (2017, 'minio操作记录', 2000, 1, 'minio_record', 'minio/minio_record/index', NULL, '', 1, 0, 'C', '0', '0', 'minio:minio_record:list', '#', 'admin', '2025-07-20 22:34:53', '', NULL, 'minio操作记录菜单');
INSERT INTO `sys_menu` VALUES (2018, 'minio操作记录查询', 2017, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'minio:minio_record:query', '#', 'admin', '2025-07-20 22:34:53', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2019, 'minio操作记录新增', 2017, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'minio:minio_record:add', '#', 'admin', '2025-07-20 22:34:53', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2020, 'minio操作记录修改', 2017, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'minio:minio_record:edit', '#', 'admin', '2025-07-20 22:34:53', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2021, 'minio操作记录删除', 2017, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'minio:minio_record:remove', '#', 'admin', '2025-07-20 22:34:53', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2022, 'minio操作记录导出', 2017, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'minio:minio_record:export', '#', 'admin', '2025-07-20 22:34:53', '', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 161 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-07-20 22:22:50', '2025-07-15 22:53:55', 'admin', '2025-07-15 22:53:55', '', '2025-07-20 22:22:50', '管理员');
