...
-- ----------------------------
INSERT INTO `config_info` VALUES (1, 'application-dev.yml', 'DEFAULT_GROUP', 'spring:\n  autoconfigure:\n    exclude: com.alibaba.druid.spring.boot3.autoconfigure.DruidDataSourceAutoConfigure\n\n# feign 配置\nfeign:\n  sentinel:\n    enabled: true\n  okhttp:\n    enabled: true\n  httpclient:\n    enabled: false\n  client:\n    config:\n      default:\n        connectTimeout: 10000\n        readTimeout: 10000\n  compression:\n    request:\n      enabled: true\n      min-request-size: 8192\n    response:\n      enabled: true\n\n# 暴露监控端点\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\n\nlogging:\n  level:\n    # 屏蔽 Nacos 客户端的普通日志，只看报错\n    com.alibaba.nacos.client: WARN \n    # 或者更精准一点，只屏蔽这个刷屏的类\n    # com.alibaba.nacos.client.config.impl.ClientWorker: ERROR', 'cd4cd0d7086c1dc58505546f43ea4db3', '2020-05-20 12:00:00', '2026-04-26 23:05:07', NULL, '192.168.3.15', '', '', '通用配置', 'null', 'null', 'yaml', '', '');
