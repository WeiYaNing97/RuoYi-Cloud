...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储商品类别的信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of example_categories
-- ----------------------------
INSERT INTO `example_categories` VALUES (1, '家电', '家用电器大类', NULL, '2025-07-29 00:00:00', '2025-07-29 00:00:00');
INSERT INTO `example_categories` VALUES (2, '家具', '', NULL, '2025-07-30 22:35:17', '2025-07-30 22:35:17');
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储订单中每种商品的详细信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of example_order_items
-- ----------------------------
INSERT INTO `example_order_items` VALUES (7, 2, 1, 1, 9600.00, 9600.00, '联想拯救者Y7000P', NULL, 'normal');
INSERT INTO `example_order_items` VALUES (9, 2, 4, 1, 5678.00, 5678.00, '衣柜', NULL, 'normal');
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储订单的信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of example_orders
-- ----------------------------
INSERT INTO `example_orders` VALUES (2, 16, '2025-08-03 21:47:13', 15278.00, 'pending', '北京', NULL, NULL, NULL, NULL, '2025-08-03 21:47:13', '2025-08-03 22:54:07');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储支付信息' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储商品的信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of example_products
-- ----------------------------
INSERT INTO `example_products` VALUES (1, '联想拯救者Y7000P', '笔记本电脑 2024款 i14700H 4060显卡', 9600.00, 1, 10000, 'active', NULL, NULL, '2025-07-29 23:07:51', '2025-07-29 23:07:51');
INSERT INTO `example_products` VALUES (2, '美的变频空调', NULL, 2000.00, 1, 500, 'active', NULL, NULL, '2025-07-29 23:13:07', '2025-07-29 23:13:07');
INSERT INTO `example_products` VALUES (4, '衣柜', NULL, 5678.00, 2, 67, 'active', NULL, NULL, '2025-07-30 22:43:33', '2025-07-30 22:43:33');
...
CREATE TABLE `example_users`  (
  ...
  `role` int(11) NOT NULL COMMENT '用户角色（例如：user, admin）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储用户的信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of example_users
-- ----------------------------
INSERT INTO `example_users` VALUES (16, '何超莲', 'hechaolian91@163.com', 'Java0805', NULL, 'http://127.0.0.1:9005/mybucket/微信图片_20250721133303_51754221754505.png', 1, 1, NULL, '2025-08-03 19:49:24', '2025-08-03 19:49:24');
...
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'minio操作记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of minio_record
-- ----------------------------
INSERT INTO `minio_record` VALUES (42, '微信图片_20250721133303_51754221754505.png', 'http://127.0.0.1:9005/mybucket/微信图片_20250721133303_51754221754505.png', '0', 'admin', '2025-08-03 19:49:15', '', NULL, NULL);
...
INSERT INTO `sys_logininfor` VALUES (124, 'admin', '127.0.0.1', '0', '登录成功', '2025-07-28 22:20:19');
INSERT INTO `sys_logininfor` VALUES (125, 'admin', '127.0.0.1', '0', '登录成功', '2025-07-29 06:59:17');
INSERT INTO `sys_logininfor` VALUES (126, 'admin', '127.0.0.1', '0', '登录成功', '2025-07-29 07:33:26');
INSERT INTO `sys_logininfor` VALUES (127, 'admin', '127.0.0.1', '0', '登录成功', '2025-07-29 22:09:49');
INSERT INTO `sys_logininfor` VALUES (128, 'admin', '127.0.0.1', '0', '登录成功', '2025-07-30 21:01:14');
INSERT INTO `sys_logininfor` VALUES (129, 'admin', '127.0.0.1', '0', '登录成功', '2025-07-30 22:42:59');
INSERT INTO `sys_logininfor` VALUES (130, 'admin', '127.0.0.1', '0', '登录成功', '2025-07-31 20:13:31');
INSERT INTO `sys_logininfor` VALUES (131, 'admin', '127.0.0.1', '0', '登录成功', '2025-08-02 17:02:27');
INSERT INTO `sys_logininfor` VALUES (132, 'admin', '127.0.0.1', '0', '退出成功', '2025-08-03 08:03:50');
INSERT INTO `sys_logininfor` VALUES (133, 'admin', '127.0.0.1', '0', '登录成功', '2025-08-03 08:03:55');
...
) ENGINE = InnoDB AUTO_INCREMENT = 268 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_oper_log` VALUES (185, '存储商品类别的信息', 1, 'com.ruoyi.example.controller.ExampleCategoriesController.add()', 'POST', 1, 'admin', NULL, '/ExampleCategories', '127.0.0.1', '', '{\"categoryName\":\"家电\",\"createdAt\":\"2025-07-29\",\"description\":\"家用电器大类\",\"exampleId\":1,\"updatedAt\":\"2025-07-29\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-07-29 23:05:27', 138);
INSERT INTO `sys_oper_log` VALUES (186, '存储商品的信息', 1, 'com.ruoyi.example.controller.ExampleProductsController.add()', 'POST', 1, 'admin', NULL, '/ExampleProducts', '127.0.0.1', '', '{\"description\":\"笔记本电脑 2024款 i14700H 4060显卡\",\"exampleCategoryId\":1,\"exampleId\":1,\"price\":9600,\"productName\":\"联想拯救者Y7000P\",\"stockQuantity\":10000}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-07-29 23:07:51', 47);
INSERT INTO `sys_oper_log` VALUES (187, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"email\":\"HeChaoLian521WeiYaNing@163.com\",\"exampleId\":1,\"isActive\":1,\"passwordHash\":\"Wei971106\",\"role\":\"admin\",\"username\":\"何超莲\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-07-29 23:09:30', 30);
INSERT INTO `sys_oper_log` VALUES (188, '存储商品的信息', 1, 'com.ruoyi.example.controller.ExampleProductsController.add()', 'POST', 1, 'admin', NULL, '/ExampleProducts', '127.0.0.1', '', '{\"exampleCategoryId\":1,\"exampleId\":2,\"price\":2000,\"productName\":\"美的变频空调\",\"stockQuantity\":500}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-07-29 23:13:08', 154);
INSERT INTO `sys_oper_log` VALUES (189, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleOrderId\":1,\"exampleProductId\":1,\"productName\":\"联想拯救者Y7000P\",\"quantity\":2,\"totalPrice\":19200,\"unitPrice\":9600}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLIntegrityConstraintViolationException: Cannot add or update a child row: a foreign key constraint fails (`ry-cloud`.`example_order_items`, CONSTRAINT `example_order_items_ibfk_1` FOREIGN KEY (`example_order_id`) REFERENCES `example_orders` (`example_id`) ON DELETE CASCADE ON UPDATE RESTRICT)\r\n### The error may exist in file [D:\\ideaproject\\RuoYi-Cloud\\ruoyi-example\\target\\classes\\mapper\\example\\ExampleOrderItemsMapper.xml]\r\n### The error may involve com.ruoyi.example.mapper.ExampleOrderItemsMapper.insertExampleOrderItems-Inline\r\n### The error occurred while setting parameters\r\n### SQL: insert into example_order_items          ( example_order_id,             example_product_id,             quantity,             unit_price,             total_price,             product_name )           values ( ?,             ?,             ?,             ?,             ?,             ? )\r\n### Cause: java.sql.SQLIntegrityConstraintViolationException: Cannot add or update a child row: a foreign key constraint fails (`ry-cloud`.`example_order_items`, CONSTRAINT `example_order_items_ibfk_1` FOREIGN KEY (`example_order_id`) REFERENCES `example_orders` (`example_id`) ON DELETE CASCADE ON UPDATE RESTRICT)\n; Cannot add or update a child row: a foreign key constraint fails (`ry-cloud`.`example_order_items`, CONSTRAINT `example_order_items_ibfk_1` FOREIGN KEY (`example_order_id`) REFERENCES `example_orders` (`example_id`) ON DELETE CASCADE ON UPDATE RESTRICT); nested exception is java.sql.SQLIntegrityConstraintViolationException: Cannot add or update a child row: a foreign key constraint fails (`ry-cloud`.`example_order_items`, CONSTRAINT `example_order_items_ibfk_1` FOREIGN KEY (`example_order_id`) REFERENCES `example_orders` (`example_id`) ON DELETE CASCADE ON UPDATE RESTRICT)', '2025-07-29 23:14:58', 270);
INSERT INTO `sys_oper_log` VALUES (190, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":2,\"exampleOrderId\":1,\"exampleProductId\":1,\"productName\":\"联想拯救者Y7000P\",\"quantity\":2,\"totalPrice\":19200,\"unitPrice\":9600}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-07-29 23:17:07', 5);
INSERT INTO `sys_oper_log` VALUES (191, '存储商品的信息', 2, 'com.ruoyi.example.controller.ExampleProductsController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleProducts', '127.0.0.1', '', '{\"createdAt\":\"2025-07-29\",\"exampleCategoryId\":2,\"exampleId\":2,\"price\":2000,\"productName\":\"美的变频空调\",\"status\":\"active\",\"stockQuantity\":500,\"updatedAt\":\"2025-07-29\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLIntegrityConstraintViolationException: Cannot add or update a child row: a foreign key constraint fails (`ry-cloud`.`example_products`, CONSTRAINT `example_products_ibfk_1` FOREIGN KEY (`example_category_id`) REFERENCES `example_categories` (`example_id`) ON DELETE CASCADE ON UPDATE RESTRICT)\r\n### The error may exist in file [D:\\ideaproject\\RuoYi-Cloud\\ruoyi-example\\target\\classes\\mapper\\example\\ExampleProductsMapper.xml]\r\n### The error may involve com.ruoyi.example.mapper.ExampleProductsMapper.updateExampleProducts-Inline\r\n### The error occurred while setting parameters\r\n### SQL: update example_products          SET product_name = ?,                          price = ?,             example_category_id = ?,             stock_quantity = ?,             status = ?,                                       created_at = ?,             updated_at = ?          where example_id = ?\r\n### Cause: java.sql.SQLIntegrityConstraintViolationException: Cannot add or update a child row: a foreign key constraint fails (`ry-cloud`.`example_products`, CONSTRAINT `example_products_ibfk_1` FOREIGN KEY (`example_category_id`) REFERENCES `example_categories` (`example_id`) ON DELETE CASCADE ON UPDATE RESTRICT)\n; Cannot add or update a child row: a foreign key constraint fails (`ry-cloud`.`example_products`, CONSTRAINT `example_products_ibfk_1` FOREIGN KEY (`example_category_id`) REFERENCES `example_categories` (`example_id`) ON DELETE CASCADE ON UPDATE RESTRICT); nested exception is java.sql.SQLIntegrityConstraintViolationException: Cannot add or update a child row: a foreign key constraint fails (`ry-cloud`.`example_products`, CONSTRAINT `example_products_ibfk_1` FOREIGN KEY (`example_category_id`) REFERENCES `example_categories` (`example_id`) ON DELETE CASCADE ON UPDATE RESTRICT)', '2025-07-30 21:20:08', 117);
INSERT INTO `sys_oper_log` VALUES (192, '存储商品的信息', 1, 'com.ruoyi.example.controller.ExampleProductsController.add()', 'POST', 1, 'admin', NULL, '/ExampleProducts', '127.0.0.1', '', '{\"exampleCategoryId\":1,\"exampleId\":3,\"price\":1,\"productName\":\"1\",\"stockQuantity\":1}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-07-30 21:20:22', 7);
INSERT INTO `sys_oper_log` VALUES (193, '存储商品的信息', 3, 'com.ruoyi.example.controller.ExampleProductsController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleProducts/3', '127.0.0.1', '', '[3]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-07-30 21:20:32', 8);
INSERT INTO `sys_oper_log` VALUES (194, '存储商品类别的信息', 1, 'com.ruoyi.example.controller.ExampleCategoriesController.add()', 'POST', 1, 'admin', NULL, '/ExampleCategories', '127.0.0.1', '', '{\"categoryName\":\"家具\",\"description\":\"\",\"exampleId\":2}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-07-30 22:35:18', 115);
INSERT INTO `sys_oper_log` VALUES (195, '存储商品的信息', 1, 'com.ruoyi.example.controller.ExampleProductsController.add()', 'POST', 1, 'admin', NULL, '/ExampleProducts', '127.0.0.1', '', '{\"exampleCategoryId\":2,\"exampleId\":4,\"price\":5678,\"productName\":\"衣柜\",\"stockQuantity\":67}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-07-30 22:43:33', 31);
INSERT INTO `sys_oper_log` VALUES (196, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"email\":\"1\",\"exampleId\":2,\"isActive\":0,\"passwordHash\":\"1\",\"role\":2,\"username\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-02 17:34:48', 126);
INSERT INTO `sys_oper_log` VALUES (197, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"email\":\"2\",\"exampleId\":3,\"isActive\":1,\"passwordHash\":\"2\",\"role\":1,\"username\":\"2\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-02 18:14:45', 7);
INSERT INTO `sys_oper_log` VALUES (198, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005\\\\mybucket\\\\微信图片_20250721133303_51754179451614.png\",\"email\":\"3\",\"exampleId\":4,\"isActive\":1,\"passwordHash\":\"3\",\"phone\":\"3\",\"role\":1,\"username\":\"3\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 08:04:43', 26);
INSERT INTO `sys_oper_log` VALUES (199, 'minio操作记录', 3, 'com.ruoyi.minio.controller.MinioRecordController.remove()', 'DELETE', 1, 'admin', NULL, '/minio_record/10,11,12,13,14,15,16,17', '127.0.0.1', '', '[10,11,12,13,14,15,16,17]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 08:11:14', 108);
INSERT INTO `sys_oper_log` VALUES (200, 'minio操作记录', 3, 'com.ruoyi.minio.controller.MinioRecordController.remove()', 'DELETE', 1, 'admin', NULL, '/minio_record/19,20,21,22,23,24', '127.0.0.1', '', '[19,20,21,22,23,24]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 08:32:55', 145);
INSERT INTO `sys_oper_log` VALUES (201, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/4', '127.0.0.1', '', '[4]', NULL, 0, NULL, '2025-08-03 13:04:09', 7312);
INSERT INTO `sys_oper_log` VALUES (202, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005\\\\mybucket\\\\微信图片_20250721133303_51754197515489.png\",\"email\":\"5\",\"exampleId\":5,\"isActive\":1,\"passwordHash\":\"5\",\"role\":2,\"username\":\"5\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:05:28', 108);
INSERT INTO `sys_oper_log` VALUES (203, '存储用户的信息', 2, 'com.ruoyi.example.controller.ExampleUsersController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005\\\\mybucket\\\\微信图片_20250721133303_51754197547021.png\",\"createdAt\":\"2025-08-02\",\"email\":\"2\",\"exampleId\":3,\"isActive\":1,\"passwordHash\":\"2\",\"role\":1,\"updatedAt\":\"2025-08-02\",\"username\":\"2\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:05:50', 34);
INSERT INTO `sys_oper_log` VALUES (204, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/1,2,3,4', '127.0.0.1', '', '[1,2,3,4]', NULL, 0, NULL, '2025-08-03 13:06:12', 6437);
INSERT INTO `sys_oper_log` VALUES (205, '存储用户的信息', 2, 'com.ruoyi.example.controller.ExampleUsersController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005\\\\mybucket\\\\微信图片_20250721133303_51754179451614.png\",\"createdAt\":\"2025-08-03\",\"email\":\"3\",\"exampleId\":4,\"isActive\":1,\"passwordHash\":\"3\",\"phone\":\"3\",\"role\":2,\"updatedAt\":\"2025-08-03\",\"username\":\"3\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:11:17', 10);
INSERT INTO `sys_oper_log` VALUES (206, '存储用户的信息', 2, 'com.ruoyi.example.controller.ExampleUsersController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005\\\\mybucket\\\\微信图片_20250721133303_51754197547021.png\",\"createdAt\":\"2025-08-02\",\"email\":\"2\",\"exampleId\":3,\"isActive\":1,\"passwordHash\":\"2\",\"role\":2,\"updatedAt\":\"2025-08-02\",\"username\":\"2\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:11:28', 11);
INSERT INTO `sys_oper_log` VALUES (207, '存储用户的信息', 2, 'com.ruoyi.example.controller.ExampleUsersController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"createdAt\":\"2025-08-02\",\"email\":\"1\",\"exampleId\":2,\"isActive\":1,\"passwordHash\":\"1\",\"role\":2,\"updatedAt\":\"2025-08-02\",\"username\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:11:35', 13);
INSERT INTO `sys_oper_log` VALUES (208, '存储用户的信息', 2, 'com.ruoyi.example.controller.ExampleUsersController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"createdAt\":\"2025-07-29\",\"email\":\"HeChaoLian521WeiYaNing@163.com\",\"exampleId\":1,\"isActive\":1,\"passwordHash\":\"Wei971106\",\"role\":1,\"updatedAt\":\"2025-07-31\",\"username\":\"何超莲\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:11:43', 15);
INSERT INTO `sys_oper_log` VALUES (209, '存储用户的信息', 2, 'com.ruoyi.example.controller.ExampleUsersController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"createdAt\":\"2025-07-29\",\"email\":\"HeChaoLian521WeiYaNing@163.com\",\"exampleId\":1,\"isActive\":1,\"passwordHash\":\"Wei971106\",\"phone\":\"15297687688\",\"role\":1,\"updatedAt\":\"2025-07-31\",\"username\":\"何超莲\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:12:05', 7);
INSERT INTO `sys_oper_log` VALUES (210, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/1,2,3,4,5', '127.0.0.1', '', '[1,2,3,4,5]', NULL, 1, 'object name must not be null.', '2025-08-03 13:24:25', 101);
INSERT INTO `sys_oper_log` VALUES (211, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/3,4,5', '127.0.0.1', '', '[3,4,5]', NULL, 1, 'java.lang.reflect.UndeclaredThrowableException\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:779)\r\n	at org.springframework.aop.aspectj.AspectJAfterThrowingAdvice.invoke(AspectJAfterThrowingAdvice.java:64)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.AfterReturningAdviceInterceptor.invoke(AfterReturningAdviceInterceptor.java:57)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor.invoke(MethodBeforeAdviceInterceptor.java:58)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.aspectj.MethodInvocationProceedingJoinPoint.proceed(MethodInvocationProceedingJoinPoint.java:89)\r\n	at com.ruoyi.common.security.aspect.PreAuthorizeAspect.around(PreAuthorizeAspect.java:60)\r\n	at java.base/jdk.internal.reflect.DirectMethodHandleAccessor.invoke(DirectMethodHandleAccessor.java:103)\r\n	at java.base/java.lang.reflect.Method.invoke(Method.java:580)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethodWithGivenArgs(AbstractAspectJAdvice.java:634)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethod(AbstractAspectJAdvice.java:624)\r\n	at org.springframework.aop.aspectj.AspectJAroundAdvice.invoke(AspectJAroundAdvice.java:72)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.', '2025-08-03 13:24:33', 73);
INSERT INTO `sys_oper_log` VALUES (212, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/3,4,5', '127.0.0.1', '', '[3,4,5]', NULL, 1, 'java.lang.reflect.UndeclaredThrowableException\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:779)\r\n	at org.springframework.aop.aspectj.AspectJAfterThrowingAdvice.invoke(AspectJAfterThrowingAdvice.java:64)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.AfterReturningAdviceInterceptor.invoke(AfterReturningAdviceInterceptor.java:57)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor.invoke(MethodBeforeAdviceInterceptor.java:58)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.aspectj.MethodInvocationProceedingJoinPoint.proceed(MethodInvocationProceedingJoinPoint.java:89)\r\n	at com.ruoyi.common.security.aspect.PreAuthorizeAspect.around(PreAuthorizeAspect.java:60)\r\n	at java.base/jdk.internal.reflect.DirectMethodHandleAccessor.invoke(DirectMethodHandleAccessor.java:103)\r\n	at java.base/java.lang.reflect.Method.invoke(Method.java:580)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethodWithGivenArgs(AbstractAspectJAdvice.java:634)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethod(AbstractAspectJAdvice.java:624)\r\n	at org.springframework.aop.aspectj.AspectJAroundAdvice.invoke(AspectJAroundAdvice.java:72)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.', '2025-08-03 13:26:08', 19099);
INSERT INTO `sys_oper_log` VALUES (213, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/5', '127.0.0.1', '', '[5]', NULL, 1, 'java.lang.reflect.UndeclaredThrowableException\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:779)\r\n	at org.springframework.aop.aspectj.AspectJAfterThrowingAdvice.invoke(AspectJAfterThrowingAdvice.java:64)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.AfterReturningAdviceInterceptor.invoke(AfterReturningAdviceInterceptor.java:57)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor.invoke(MethodBeforeAdviceInterceptor.java:58)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.aspectj.MethodInvocationProceedingJoinPoint.proceed(MethodInvocationProceedingJoinPoint.java:89)\r\n	at com.ruoyi.common.security.aspect.PreAuthorizeAspect.around(PreAuthorizeAspect.java:60)\r\n	at java.base/jdk.internal.reflect.DirectMethodHandleAccessor.invoke(DirectMethodHandleAccessor.java:103)\r\n	at java.base/java.lang.reflect.Method.invoke(Method.java:580)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethodWithGivenArgs(AbstractAspectJAdvice.java:634)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethod(AbstractAspectJAdvice.java:624)\r\n	at org.springframework.aop.aspectj.AspectJAroundAdvice.invoke(AspectJAroundAdvice.java:72)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.', '2025-08-03 13:26:58', 2808);
INSERT INTO `sys_oper_log` VALUES (214, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/5', '127.0.0.1', '', '[5]', NULL, 1, 'java.lang.reflect.UndeclaredThrowableException\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:779)\r\n	at org.springframework.aop.aspectj.AspectJAfterThrowingAdvice.invoke(AspectJAfterThrowingAdvice.java:64)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.AfterReturningAdviceInterceptor.invoke(AfterReturningAdviceInterceptor.java:57)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor.invoke(MethodBeforeAdviceInterceptor.java:58)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.aspectj.MethodInvocationProceedingJoinPoint.proceed(MethodInvocationProceedingJoinPoint.java:89)\r\n	at com.ruoyi.common.security.aspect.PreAuthorizeAspect.around(PreAuthorizeAspect.java:60)\r\n	at java.base/jdk.internal.reflect.DirectMethodHandleAccessor.invoke(DirectMethodHandleAccessor.java:103)\r\n	at java.base/java.lang.reflect.Method.invoke(Method.java:580)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethodWithGivenArgs(AbstractAspectJAdvice.java:634)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethod(AbstractAspectJAdvice.java:624)\r\n	at org.springframework.aop.aspectj.AspectJAroundAdvice.invoke(AspectJAroundAdvice.java:72)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.', '2025-08-03 13:27:47', 24909);
INSERT INTO `sys_oper_log` VALUES (215, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/5', '127.0.0.1', '', '[5]', NULL, 1, 'java.lang.reflect.UndeclaredThrowableException\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:779)\r\n	at org.springframework.aop.aspectj.AspectJAfterThrowingAdvice.invoke(AspectJAfterThrowingAdvice.java:64)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.AfterReturningAdviceInterceptor.invoke(AfterReturningAdviceInterceptor.java:57)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor.invoke(MethodBeforeAdviceInterceptor.java:58)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.aspectj.MethodInvocationProceedingJoinPoint.proceed(MethodInvocationProceedingJoinPoint.java:89)\r\n	at com.ruoyi.common.security.aspect.PreAuthorizeAspect.around(PreAuthorizeAspect.java:60)\r\n	at java.base/jdk.internal.reflect.DirectMethodHandleAccessor.invoke(DirectMethodHandleAccessor.java:103)\r\n	at java.base/java.lang.reflect.Method.invoke(Method.java:580)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethodWithGivenArgs(AbstractAspectJAdvice.java:634)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethod(AbstractAspectJAdvice.java:624)\r\n	at org.springframework.aop.aspectj.AspectJAroundAdvice.invoke(AspectJAroundAdvice.java:72)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.', '2025-08-03 13:29:33', 68017);
INSERT INTO `sys_oper_log` VALUES (216, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/5', '127.0.0.1', '', '[5]', NULL, 1, 'java.lang.reflect.UndeclaredThrowableException\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:779)\r\n	at org.springframework.aop.aspectj.AspectJAfterThrowingAdvice.invoke(AspectJAfterThrowingAdvice.java:64)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.AfterReturningAdviceInterceptor.invoke(AfterReturningAdviceInterceptor.java:57)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor.invoke(MethodBeforeAdviceInterceptor.java:58)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.springframework.aop.framework.CglibAopProxy$CglibMethodInvocation.proceed(CglibAopProxy.java:762)\r\n	at org.springframework.aop.aspectj.MethodInvocationProceedingJoinPoint.proceed(MethodInvocationProceedingJoinPoint.java:89)\r\n	at com.ruoyi.common.security.aspect.PreAuthorizeAspect.around(PreAuthorizeAspect.java:60)\r\n	at java.base/jdk.internal.reflect.DirectMethodHandleAccessor.invoke(DirectMethodHandleAccessor.java:103)\r\n	at java.base/java.lang.reflect.Method.invoke(Method.java:580)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethodWithGivenArgs(AbstractAspectJAdvice.java:634)\r\n	at org.springframework.aop.aspectj.AbstractAspectJAdvice.invokeAdviceMethod(AbstractAspectJAdvice.java:624)\r\n	at org.springframework.aop.aspectj.AspectJAroundAdvice.invoke(AspectJAroundAdvice.java:72)\r\n	at org.springframework.aop.framework.ReflectiveMethodInvocation.proceed(ReflectiveMethodInvocation.java:175)\r\n	at org.', '2025-08-03 13:30:36', 23246);
INSERT INTO `sys_oper_log` VALUES (217, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/5', '127.0.0.1', '', '[5]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:32:35', 19);
INSERT INTO `sys_oper_log` VALUES (218, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/3,4', '127.0.0.1', '', '[3,4]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:32:55', 28);
INSERT INTO `sys_oper_log` VALUES (219, 'minio操作记录', 3, 'com.ruoyi.minio.controller.MinioRecordController.remove()', 'DELETE', 1, 'admin', NULL, '/minio_record/18,25,26,27,28', '127.0.0.1', '', '[18,25,26,27,28]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:33:42', 232);
INSERT INTO `sys_oper_log` VALUES (220, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/1,2', '127.0.0.1', '', '[1,2]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:33:55', 23);
INSERT INTO `sys_oper_log` VALUES (221, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005\\\\mybucket\\\\微信图片_20250721133303_51754199245762.png\",\"email\":\"1\",\"exampleId\":6,\"isActive\":0,\"passwordHash\":\"1\",\"phone\":\"1\",\"role\":2,\"username\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:34:19', 100);
INSERT INTO `sys_oper_log` VALUES (222, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005\\\\mybucket\\\\微信图片_20250721133303_51754199277434.png\",\"email\":\"2\",\"exampleId\":7,\"isActive\":1,\"passwordHash\":\"2\",\"role\":2,\"username\":\"2\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:35:01', 4);
INSERT INTO `sys_oper_log` VALUES (223, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/6,7', '127.0.0.1', '', '[6,7]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:37:36', 208);
INSERT INTO `sys_oper_log` VALUES (224, 'minio操作记录', 3, 'com.ruoyi.minio.controller.MinioRecordController.remove()', 'DELETE', 1, 'admin', NULL, '/minio_record/29,30,31,32', '127.0.0.1', '', '[29,30,31,32]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:38:10', 152);
INSERT INTO `sys_oper_log` VALUES (225, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005\\\\mybucket\\\\微信图片_20250721133303_51754199505487.png\",\"email\":\"1\",\"exampleId\":8,\"isActive\":1,\"passwordHash\":\"1\",\"role\":2,\"username\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:38:40', 93);
INSERT INTO `sys_oper_log` VALUES (226, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/8', '127.0.0.1', '', '[8]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:40:27', 8371);
INSERT INTO `sys_oper_log` VALUES (227, 'minio操作记录', 3, 'com.ruoyi.minio.controller.MinioRecordController.remove()', 'DELETE', 1, 'admin', NULL, '/minio_record/33', '127.0.0.1', '', '[33]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:41:20', 44);
INSERT INTO `sys_oper_log` VALUES (228, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005\\\\mybucket\\\\微信图片_20250721133303_51754199787169.png\",\"email\":\"1\",\"exampleId\":9,\"isActive\":1,\"passwordHash\":\"1\",\"role\":2,\"username\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:43:14', 14);
INSERT INTO `sys_oper_log` VALUES (229, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/9', '127.0.0.1', '', '[9]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:43:39', 8849);
INSERT INTO `sys_oper_log` VALUES (230, 'minio操作记录', 3, 'com.ruoyi.minio.controller.MinioRecordController.remove()', 'DELETE', 1, 'admin', NULL, '/minio_record/34', '127.0.0.1', '', '[34]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:50:17', 109);
INSERT INTO `sys_oper_log` VALUES (231, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005/mybucket/微信图片_20250721133303_51754200234993.png\",\"email\":\"1\",\"exampleId\":10,\"isActive\":1,\"passwordHash\":\"1\",\"role\":2,\"username\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:50:45', 131);
INSERT INTO `sys_oper_log` VALUES (232, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/10', '127.0.0.1', '', '[10]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:51:03', 3859);
INSERT INTO `sys_oper_log` VALUES (233, 'minio操作记录', 3, 'com.ruoyi.minio.controller.MinioRecordController.remove()', 'DELETE', 1, 'admin', NULL, '/minio_record/35', '127.0.0.1', '', '[35]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:53:10', 67);
INSERT INTO `sys_oper_log` VALUES (234, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005/mybucket/微信图片_20250721133303_51754200420865.png\",\"email\":\"8\",\"exampleId\":11,\"isActive\":1,\"passwordHash\":\"9\",\"role\":1,\"username\":\"7\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:53:54', 15);
INSERT INTO `sys_oper_log` VALUES (235, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/11', '127.0.0.1', '', '[11]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 13:56:26', 6568);
INSERT INTO `sys_oper_log` VALUES (236, 'minio操作记录', 3, 'com.ruoyi.minio.controller.MinioRecordController.remove()', 'DELETE', 1, 'admin', NULL, '/minio_record/36', '127.0.0.1', '', '[36]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:00:17', 5);
INSERT INTO `sys_oper_log` VALUES (237, 'minio操作记录', 3, 'com.ruoyi.minio.controller.MinioRecordController.remove()', 'DELETE', 1, 'admin', NULL, '/minio_record/37', '127.0.0.1', '', '[37]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:08:11', 97);
INSERT INTO `sys_oper_log` VALUES (238, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005/mybucket/微信图片_20250721133303_51754201313287.png\",\"email\":\"hfg\",\"exampleId\":12,\"isActive\":1,\"passwordHash\":\"gdf\",\"role\":1,\"username\":\"sdf\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:08:47', 14);
INSERT INTO `sys_oper_log` VALUES (239, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/12', '127.0.0.1', '', '[12]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:09:03', 31);
INSERT INTO `sys_oper_log` VALUES (240, 'minio操作记录', 3, 'com.ruoyi.minio.controller.MinioRecordController.remove()', 'DELETE', 1, 'admin', NULL, '/minio_record/38', '127.0.0.1', '', '[38]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:09:27', 24);
INSERT INTO `sys_oper_log` VALUES (241, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005/mybucket/微信图片_20250721133303_51754202206208.png\",\"email\":\"1\",\"exampleId\":13,\"isActive\":1,\"passwordHash\":\"1\",\"role\":1,\"username\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:23:33', 130);
INSERT INTO `sys_oper_log` VALUES (242, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/13', '127.0.0.1', '', '[13]', NULL, 1, '\r\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Unknown column \'search_value\' in \'field list\'\r\n### The error may exist in com/ruoyi/minio/mapper/MinioRecordMapper.java (best guess)\r\n### The error may involve defaultParameterMap\r\n### The error occurred while setting parameters\r\n### SQL: SELECT    id,file_name,file_path,del_flag,search_value,create_by,create_time,update_by,update_time,remark,params    FROM  minio_record         WHERE  (file_path >= ?)\r\n### Cause: java.sql.SQLSyntaxErrorException: Unknown column \'search_value\' in \'field list\'\n; bad SQL grammar []; nested exception is java.sql.SQLSyntaxErrorException: Unknown column \'search_value\' in \'field list\'', '2025-08-03 14:23:41', 310);
INSERT INTO `sys_oper_log` VALUES (243, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/13', '127.0.0.1', '', '[13]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:28:53', 115);
INSERT INTO `sys_oper_log` VALUES (244, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005/mybucket/微信图片_20250721133303_51754202690696.png\",\"email\":\"q\",\"exampleId\":14,\"isActive\":1,\"passwordHash\":\"q\",\"role\":1,\"username\":\"q\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:31:36', 83);
INSERT INTO `sys_oper_log` VALUES (245, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/14', '127.0.0.1', '', '[14]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:32:10', 11);
INSERT INTO `sys_oper_log` VALUES (246, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005/mybucket/微信图片_20250721133303_51754202771263.png\",\"email\":\"g\",\"exampleId\":15,\"isActive\":1,\"passwordHash\":\"g\",\"role\":1,\"username\":\"g\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:32:57', 6);
INSERT INTO `sys_oper_log` VALUES (247, '存储用户的信息', 3, 'com.ruoyi.example.controller.ExampleUsersController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleUsers/15', '127.0.0.1', '', '[15]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 14:37:29', 4645);
INSERT INTO `sys_oper_log` VALUES (248, '存储用户的信息', 1, 'com.ruoyi.example.controller.ExampleUsersController.add()', 'POST', 1, 'admin', NULL, '/ExampleUsers', '127.0.0.1', '', '{\"avatarUrl\":\"http://127.0.0.1:9005/mybucket/微信图片_20250721133303_51754221754505.png\",\"email\":\"hechaolian91@163.com\",\"exampleId\":16,\"isActive\":1,\"passwordHash\":\"Java0805\",\"role\":1,\"username\":\"何超莲\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 19:49:24', 121);
INSERT INTO `sys_oper_log` VALUES (249, '存储订单的信息', 1, 'com.ruoyi.example.controller.ExampleOrdersController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrders', '127.0.0.1', '', '{\"exampleId\":2,\"exampleUserId\":16,\"shippingAddress\":\"北京\",\"totalAmount\":0}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 21:47:13', 78);
INSERT INTO `sys_oper_log` VALUES (250, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":3,\"exampleOrderId\":2,\"exampleProductId\":1,\"productName\":\"联想拯救者Y7000P\",\"quantity\":4,\"totalPrice\":38400,\"unitPrice\":9600}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:06:21', 23);
INSERT INTO `sys_oper_log` VALUES (251, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":4,\"exampleOrderId\":2,\"exampleProductId\":2,\"productName\":\"美的变频空调\",\"quantity\":1,\"totalPrice\":2000,\"unitPrice\":2000}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:31:37', 47);
INSERT INTO `sys_oper_log` VALUES (252, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":5,\"exampleOrderId\":2,\"exampleProductId\":4,\"productName\":\"衣柜\",\"quantity\":1,\"totalPrice\":5678,\"unitPrice\":5678}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:33:55', 26951);
INSERT INTO `sys_oper_log` VALUES (253, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":6,\"exampleOrderId\":2,\"exampleProductId\":4,\"productName\":\"衣柜\",\"quantity\":1,\"totalPrice\":5678,\"unitPrice\":5678}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:35:19', 6473);
INSERT INTO `sys_oper_log` VALUES (254, '存储订单中每种商品的详细信息', 3, 'com.ruoyi.example.controller.ExampleOrderItemsController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleOrderItems/3,4,5,6', '127.0.0.1', '', '[3,4,5,6]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:35:47', 18);
INSERT INTO `sys_oper_log` VALUES (255, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":7,\"exampleOrderId\":2,\"exampleProductId\":1,\"productName\":\"联想拯救者Y7000P\",\"quantity\":1,\"totalPrice\":9600,\"unitPrice\":9600}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:36:06', 3011);
INSERT INTO `sys_oper_log` VALUES (256, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":8,\"exampleOrderId\":2,\"exampleProductId\":2,\"productName\":\"美的变频空调\",\"quantity\":4,\"totalPrice\":8000,\"unitPrice\":2000}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:36:27', 25);
INSERT INTO `sys_oper_log` VALUES (257, '存储订单中每种商品的详细信息', 2, 'com.ruoyi.example.controller.ExampleOrderItemsController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":8,\"exampleOrderId\":2,\"exampleProductId\":2,\"productName\":\"美的变频空调\",\"quantity\":5,\"status\":\"normal\",\"totalPrice\":10000,\"unitPrice\":2000}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:36:53', 26);
INSERT INTO `sys_oper_log` VALUES (258, '存储订单中每种商品的详细信息', 2, 'com.ruoyi.example.controller.ExampleOrderItemsController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":8,\"exampleOrderId\":2,\"exampleProductId\":2,\"productName\":\"美的变频空调\",\"quantity\":10,\"status\":\"normal\",\"totalPrice\":20000,\"unitPrice\":2000}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:37:37', 26);
INSERT INTO `sys_oper_log` VALUES (259, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":9,\"exampleOrderId\":2,\"exampleProductId\":4,\"productName\":\"衣柜\",\"quantity\":1,\"totalPrice\":5678,\"unitPrice\":5678}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:38:14', 21);
INSERT INTO `sys_oper_log` VALUES (260, '存储订单中每种商品的详细信息', 2, 'com.ruoyi.example.controller.ExampleOrderItemsController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":8,\"exampleOrderId\":2,\"exampleProductId\":2,\"productName\":\"美的变频空调\",\"quantity\":9,\"status\":\"normal\",\"totalPrice\":18000,\"unitPrice\":2000}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:43:44', 8489);
INSERT INTO `sys_oper_log` VALUES (261, '存储订单中每种商品的详细信息', 2, 'com.ruoyi.example.controller.ExampleOrderItemsController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":8,\"exampleOrderId\":2,\"exampleProductId\":2,\"productName\":\"美的变频空调\",\"quantity\":8,\"status\":\"normal\",\"totalPrice\":16000,\"unitPrice\":2000}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:44:06', 29);
INSERT INTO `sys_oper_log` VALUES (262, '存储订单中每种商品的详细信息', 2, 'com.ruoyi.example.controller.ExampleOrderItemsController.edit()', 'PUT', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":8,\"exampleOrderId\":2,\"exampleProductId\":2,\"productName\":\"美的变频空调\",\"quantity\":10,\"status\":\"normal\",\"totalPrice\":20000,\"unitPrice\":2000}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:50:36', 263);
INSERT INTO `sys_oper_log` VALUES (263, '存储订单中每种商品的详细信息', 3, 'com.ruoyi.example.controller.ExampleOrderItemsController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleOrderItems/8', '127.0.0.1', '', '[8]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:50:56', 20);
INSERT INTO `sys_oper_log` VALUES (264, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":10,\"exampleOrderId\":2,\"exampleProductId\":2,\"productName\":\"美的变频空调\",\"quantity\":10,\"totalPrice\":20000,\"unitPrice\":2000}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:51:25', 36);
INSERT INTO `sys_oper_log` VALUES (265, '存储订单中每种商品的详细信息', 3, 'com.ruoyi.example.controller.ExampleOrderItemsController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleOrderItems/10', '127.0.0.1', '', '[10]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:51:56', 57);
INSERT INTO `sys_oper_log` VALUES (266, '存储订单中每种商品的详细信息', 1, 'com.ruoyi.example.controller.ExampleOrderItemsController.add()', 'POST', 1, 'admin', NULL, '/ExampleOrderItems', '127.0.0.1', '', '{\"exampleId\":11,\"exampleOrderId\":2,\"exampleProductId\":2,\"productName\":\"美的变频空调\",\"quantity\":10,\"totalPrice\":20000,\"unitPrice\":2000}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:52:37', 144);
INSERT INTO `sys_oper_log` VALUES (267, '存储订单中每种商品的详细信息', 3, 'com.ruoyi.example.controller.ExampleOrderItemsController.remove()', 'DELETE', 1, 'admin', NULL, '/ExampleOrderItems/11', '127.0.0.1', '', '[11]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-08-03 22:54:07', 9523);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-08-03 08:03:56', '2025-07-15 22:53:55', 'admin', '2025-07-15 22:53:55', '', '2025-08-03 08:03:55', '管理员');
