...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储订单中每种商品的详细信息' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储订单的信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `example_users`  (
  ...
  `role` int(11) NOT NULL DEFAULT 'user' COMMENT '用户角色（例如：user, admin）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '存储用户的信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of example_users
-- ----------------------------
INSERT INTO `example_users` VALUES (1, '何超莲', 'HeChaoLian521WeiYaNing@163.com', 'Wei971106', NULL, NULL, 1, 1, NULL, '2025-07-29 23:09:30', '2025-07-31 20:38:45');
...
) ENGINE = InnoDB AUTO_INCREMENT = 131 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 196 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-07-31 20:13:31', '2025-07-15 22:53:55', 'admin', '2025-07-15 22:53:55', '', '2025-07-31 20:13:31', '管理员');
